...
if ( ! class_exists( 'Learts_Woo' ) ) {
	...
	class Learts_Woo {
		...
		public function __construct() {
			...
			// add_action( 'woocommerce_order_status_pending', 'wc_maybe_reduce_stock_levels2' ); 
			
			// add_action( 'woocommerce_order_status_pending', 'order_stock_reduction_based_on_payment_method', 20, 2 ); 
		...
		public static function wishlist_button() {
			if ( class_exists( 'YITH_WCWL' ) && 'yes' == get_option( 'yith_wcwl_enabled' ) && learts_get_option( 'shop_wishlist_on' ) ) {
		...
		public function wc_maybe_reduce_stock_levels2( $order_id ) {

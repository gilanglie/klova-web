						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">
									...
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/slider-and-carousel-plus-widget-for-instagram-demo/" target="_blank"><?php _e('Demo for Designs', 'slider-and-carousel-plus-widget-for-instagram'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->

...
! defined( 'WOOBT_VERSION' ) && define( 'WOOBT_VERSION', '1.5.9' );
			...
			class WPCleverWoobt {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woobt_default">
                                                    ...
                                                    <option
                                                            value="related_upsells" <?php echo( get_option( '_woobt_default', 'none' ) === 'related_upsells' ? 'selected' : '' ); ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woobt_position">
                                                    ...
                                                    <option
                                                            value="none" <?php echo( get_option( '_woobt_position', 'before' ) === 'none' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'None', 'woobt' ); ?>
                                                    </option>
                                                </select> <span
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woobt_change_price">
                                                    ...
                                                    <option
                                                            value="yes_custom" <?php echo( get_option( '_woobt_change_price', 'yes' ) === 'yes_custom' ? 'selected' : '' ); ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="_woobt_search_id">
                                                    <option
                                                            value="yes" <?php echo( get_option( '_woobt_search_id', 'no' ) === 'yes' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Yes', 'woobt' ); ?>
                                                    </option>
                                                    <option
                                                            value="no" <?php echo( get_option( '_woobt_search_id', 'no' ) === 'no' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'No', 'woobt' ); ?>
                                                    </option>
                                                </select> <span
						...
						if ( is_array( $items ) && ( count( $items ) > 0 ) ) {
							if ( $this->woobt_ready_add_to_cart( $product_id, $items ) ) {
								...
								foreach ( $items as $item ) {
									...
									if ( $woobt_product instanceof WC_Product_Variation ) {
										// ensure we don't add a variation to the cart directly by variation ID
										$woobt_item_variation_id = $woobt_item_id;
										$woobt_item_id           = $woobt_product->get_parent_id();
										$woobt_item_variation    = $woobt_product->get_variation_attributes();
									}
				...
				function woobt_get_search_results() {
					...
					if ( is_array( $ids_arrs ) && count( $ids_arrs ) > 2 ) {
						echo '<ul><span>Please use the Premium Version to add more than 3 products & get the premium support. Click <a href="https://wpclever.net/downloads/woocommerce-bought-together?utm_source=pro&utm_medium=woobt&utm_campaign=wporg" target="_blank">here</a> to buy, just $29!</span></ul>';
						die();
					}
				...
				function woobt_show_items() {
					...
					if ( ( count( $woobt_items ) == 0 ) && ( get_option( '_woobt_default', 'none' ) === 'related_upsells' ) ) {
                                ...
                                <tr class="woobt-product woobt-product-this">
                                    ...
                                    <td class="woobt-quantity">
										<?php if ( $woobt_custom_qty ) { ?>
                                            <input type="number" class="woobt-qty woobt-this-qty qty input-text text"
                                                   step="1" min="1"
                                                   value="1"/>
										<?php } ?>
                                    </td>
                                ...
                                <tr class="woobt-product woobt-product-together"
                                    ...
                                    <td class="woobt-quantity">
										...
										if ( $woobt_custom_qty ) {
											...
											echo '<span class="woobt-qty-num">' . $woobt_item_qty . '</span>';
										}
										?>
                                    </td>
									<?php if ( get_option( '_woobt_show_thumb', 'yes' ) !== 'no' ) { ?>
									...
									<?php if ( get_option( '_woobt_show_price', 'yes' ) !== 'no' ) { ?>
                                        <td class="woobt-price">
                                            ...
                                            <div class="woobt-price-ori">
												<?php if ( ! $woobt_separately && ( $woobt_item_price !== '100%' ) ) {
													$woobt_item_new_price = $this->woobt_new_price( $woobt_product->get_price(), $woobt_item_price );

													if ( $woobt_item_new_price < $woobt_product->get_price() ) {
														echo wc_format_sale_price( $woobt_product->get_price(), $woobt_item_new_price );
													} else {
														echo wc_price( $woobt_item_new_price );
													}
												} else {
				...
				function woobt_before_calculate_totals( $cart_object ) {
					...
					foreach ( $cart_object->cart_contents as $cart_item_key => $cart_item ) {
						...
						if ( ! empty( $cart_item['woobt_ids'] ) ) {
							if ( ( $discount = get_post_meta( $cart_item['product_id'], 'woobt_discount', true ) ) && ( get_post_meta( $cart_item['product_id'], 'woobt_separately', true ) !== 'on' ) ) {

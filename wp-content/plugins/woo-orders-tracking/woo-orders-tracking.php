...
define( 'VI_WOO_ORDERS_TRACKING_VERSION', '1.1.6' );
		...
		public function global_note() {
			if ( ! is_plugin_active( 'woocommerce/woocommerce.php' ) ) {
                ...
                <div id="message" class="error">
                    <p><?php _e( 'Please install and active WooCommerce to use Orders Tracking for WooCommerce plugin.', 'woo-orders-tracking' ); ?></p>
                </div>
				<?php
			}
		}
